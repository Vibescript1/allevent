...
const SubNavbar = () => {
  ...
  return (
    <div className="w-full bg-popover/90 backdrop-blur-md border-b border-border sticky top-16 z-40 shadow-elegant">
      <div
        className="
        ...
        {eventLinks.map((link) => (
          ...
          >
            ...
            {isActive(link.path) && (
              <motion.div
                key={link.path}
                className="h-[2.5px] w-[50%] md:w-[70%] mt-[3px] bg-gradient-gold rounded-full"
