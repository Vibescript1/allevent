    ...
    <p className="text-muted-foreground text-sm mt-1 tracking-wide">
      ...
      <section className="py-20 px-6 bg-gradient-to-b from-[#FAF7F0] to-white">
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          {/* Text side */}
          <div className="text-center md:text-left space-y-6 px-4 sm:px-6 md:px-0 md:pl-6 lg:pl-8 max-w-full md:max-w-none">
            <h2 className="text-3xl sm:text-4xl font-bold text-foreground relative inline-block">
              Our Mission
              <span
                className="absolute bottom-0 w-1/3 h-1 bg-[#452246] rounded-full
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="px-6 py-5 bg-[#D6A419]/10 rounded-xl">
